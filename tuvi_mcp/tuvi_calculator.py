...
def get_horoscope_chart(name: str, day: int, month: int, year: int, hour_val, gender_val, is_solar: bool = True) -> dict:
...
def get_van_han_analysis(name: str, day: int, month: int, year: int, hour_val, gender_val, is_solar: bool, current_year: int, current_month: int = 1) -> dict:
    ...
    def enrich_cung(cung):
        ...
        return {
            **cung,
            "transit_stars": cung_transits[cung_id]
        }
